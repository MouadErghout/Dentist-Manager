        ...
        <div class="max-w-5xl mx-auto sm:px-2 lg:px-2">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form id="myform" action="/RDV/{{$week}}/{{$rdv->id}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div>
                            <!-- Name -->
                            <div >
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$rdv->name}}" required autofocus />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="telephone" class="block mt-1 w-full" type="text" name="telephone" value="{{$rdv->telephone}}" required autofocus />
                            ...
                            <div class="mt-4">
                                ...
                                <select id="day-select" name="day" required>
                                    <option value="{{$rdv->day}}">Select a day</option>
                            ...
                            <div class="mt-4">
                                ...
                                <select id="time-select" name="time" required>
                                    <option value={{$rdv->time}}>Select a time</option>
                                </select>
