<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Treatement_id : {{$treatement}} seance_id : {{$seance->id}}
            <div class="flex items-center justify-end">
                <a href="/treatement/{{$treatement}}">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="/seance/{{$seance->id}}">
                        ...
                        <div>
                            ...
                            <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" value="{{$seance->description}}" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="montant" class="block mt-1 w-full" type="number" step="0.01" name="montant" value="{{$seance->montant}}" required autofocus />
