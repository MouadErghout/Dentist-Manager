            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="firstname" value="{{$client->firstname}}" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="lastname" value="{{$client->lastname}}" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="birthday" class="block mt-1 w-full" type="date" name="birthday" value="{{$client->birthday}}" required autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="" class="block mt-1 w-full" type="tel" name="phonenumber" value="{{$client->phonenumber}}" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="" class="block mt-1 w-full" type="text" name="cin" value="{{$client->cin}}"/>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="numero_securite_sociale" class="block mt-1 w-full" type="text" name="numero_securite_sociale" value="{{$client->numero_securite_sociale}}"/>
