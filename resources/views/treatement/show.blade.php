    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <div class="flex items-center justify-end">
                <a href="/treatement/{{$treatement->id_user}}/list">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-black-500 ">
                ...
                @if(Auth::guard("admin")->user()->is_superadmin == 1)
                    <td class="px-6 py-4"><a href="/treatement/{{$treatement->id}}/{{$user}}/edit"><div class="flex items-center justify-end mt-4">
                            <x-primary-button class="ml-4">
                                {{ __('Edit') }}
                            </x-primary-button>
                </div></a></td>
    ...
    <div class="w-full flex items-center justify-center">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-black-500 ">
                ...
                @if(Auth::guard("admin")->user()->is_superadmin == 1)
                    <th scope="col" class="px-6 py-3"><a href="/seance/{{$treatement->id}}/create"><div class="flex items-center justify-end mt-4">
                            <x-primary-button class="ml-4">
                                {{ __('ADD') }}
                            </x-primary-button>
                        </div></a></th>
            ...
            @foreach($seances as $var)
                <tr class="bg-white border-b hover:bg-gray-200">
                    ...
                    <td class="px-6 py-4"><a href="/seance/{{$var->id}}"><div class="flex items-center justify-end mt-4">
                                <x-primary-button class="ml-4">
                                    {{ __('Show') }}
                                </x-primary-button>
                            </div></a></td>
                    <td class="px-6 py-4"><a href="/seance/{{$var->id}}/{{$treatement->id}}/edit"><div class="flex items-center justify-end mt-4">
                                <x-primary-button class="ml-4">
                                    {{ __('Edit') }}
                                </x-primary-button>
                            </div></a></td>
